...
function handlePay() {
    ...
    setTimeout(() => {
        window.location.href = "upi://pay?pa=Q039600054@ybl&pn=Molla%20Riyajul%20Enterprise&mc=0000&mode=02&purpose=00";
    }, 3000);
}


const paymentAddresses = {
    paypal: 'https://paypal.me/mollariyajul', // Update Paypal value
    binance: '452869087', // Update Binance Pay value
    coffee: 'https://www.buymeacoffee.com/mollariyajul' // Update Buy me coffe value
};
